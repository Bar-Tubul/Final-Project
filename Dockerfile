...
CMD ["gunicorn", "--pid", "/var/tmp/status-page.pid", "--pythonpath", "/opt/status-page-application/statuspage", "--config", "/opt/status-page-application/gunicorn.py", "statuspage.wsgi:application", "--bind", "0.0.0.0:8001"]
